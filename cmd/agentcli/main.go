...
func printUsage() {
	...
	fmt.Fprintln(os.Stderr, "  agentcli loop [run|judge|autofix|all] [--repo-root path] [--threshold score] [--max-iterations n] [--branch name] [--mode classic|committee] [--role-config file] [--seed n] [--budget n] [--api url]")
