...
func printUsage() {
	...
	fmt.Fprintln(os.Stderr, "  agentcli loop [run|judge|autofix|doctor|quality|profiles|profile|<profile>|regression|capabilities|lab]")
	fmt.Fprintln(os.Stderr, "    [--format text|json|ndjson] [--summary path] [--no-color] [--dry-run] [--explain] [command flags]")
